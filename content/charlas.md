...
<style>
  .hm-title {
    background: rgba(255, 255, 255, 0); /* rosa pastel */
    padding: 20px;
    text-align: center;
    font-size: 32px;
    font-family: "Trebuchet MS", sans-serif;
    color: #b8b8b8ff;
    border-color: #d531f6ff;
    border-width: 3px;
    border-style: solid;   
    font-weight: bold;
    border-radius: 10px;
  ...
  table.hm th {
    background: #004348ff; /* verde agua */
    color: #ffffffff;
    padding: 10px;
    font-size: 18px;
    text-align: left;
  ...
  table.hm td {
    background: #031c2fff; /* rosado pastel */
    color: #c3c3c3ff;
    padding: 10px;
    font-size: 16px;
...
<div class="hm-title">CRONOGRAMA</div>

<!-- ===================== -->
<!-- CHARLAS – VIERNES -->
<!-- ===================== -->
<div class="hm-section-title">CHARLAS – Viernes 5 de diciembre</div>
...
<!-- CHARLAS – SABADO -->
<!-- ===================== -->
<div class="hm-section-title">CHARLAS – Sábado 6 de diciembre</div>
...
<!-- TALLERES – VIERNES -->
<!-- ===================== -->
<div class="hm-section-title">TALLERES – Viernes 5 de diciembre</div>
...
<!-- TALLERES – SÁBADO -->
<!-- ===================== -->
<div class="hm-section-title">TALLERES – Sábado 6 de diciembre</div>
